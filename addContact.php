...
//Run Query
$db->query("INSERT INTO `contacts` (first_name, last_name, email, phone, address1, address2, city, state, zipcode, contact_group)
								VALUES (:first_name, :last_name, :email, :phone, :address1, :address2, :city, :state, :zipcode, :contact_group)");
